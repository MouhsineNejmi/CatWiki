...
const Footer = () => {
  ...
  return (
    <div className='w-full h-[100px] sm:h-[70px] flex flex-col sm:flex-row justify-center sm:justify-between sm:items-center px-5 bg-black text-white rounded-t-[25px]'>
      <div className=''>
        <Link to='/'>
